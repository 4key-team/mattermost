...
const Preferences = {
    ...
    THEMES: {
        ...
        sapphire: {
            ...
            sidebarText: '#ffffff',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#1a4fae',
            sidebarTextActiveBorder: '#8fd11f',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#0d367d',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#0a2f6d',
            onlineIndicator: '#7cc51d',
            awayIndicator: '#ffbc1f',
            dndIndicator: '#d24b4e',
            mentionBg: '#8fd11f',
            mentionBj: '#8fd11f',
            ...
            centerChannelBg: '#ffffff',
            centerChannelColor: '#3f4350',
            newMessageSeparator: '#78bf18',
            linkColor: '#1358c8',
            buttonBg: '#1358c8',
            buttonColor: '#ffffff',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#e6f7c8',
            mentionHighlightLink: '#3f6700',
            codeTheme: 'github',
        },
        lagoon: {
            type: 'custom',
            ...
            sidebarText: '#ffffff',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#11628f',
            sidebarTextActiveBorder: '#9adf2f',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#083f63',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#073652',
            onlineIndicator: '#84d11f',
            awayIndicator: '#ffbc1f',
            dndIndicator: '#d24b4e',
            mentionBg: '#9adf2f',
            mentionBj: '#9adf2f',
            ...
            centerChannelBg: '#ffffff',
            centerChannelColor: '#3f4350',
            newMessageSeparator: '#7ec61b',
            linkColor: '#0f6db1',
            buttonBg: '#0f6db1',
            buttonColor: '#ffffff',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#edf9d5',
            mentionHighlightLink: '#406f00',
            codeTheme: 'github',
        },
        quartz: {
            type: 'Quartz',

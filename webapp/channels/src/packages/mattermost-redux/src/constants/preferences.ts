...
const Preferences = {
    ...
    THEMES: {
        ...
        sapphire: {
            ...
            sidebarText: '#ffffff',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#17466e',
            sidebarTextActiveBorder: '#80cb24',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#0a3153',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#082742',
            onlineIndicator: '#80cb24',
            awayIndicator: '#ffbc1f',
            dndIndicator: '#d24b4e',
            mentionBg: '#80cb24',
            mentionBj: '#80cb24',
            ...
            centerChannelBg: '#ffffff',
            centerChannelColor: '#3f4350',
            newMessageSeparator: '#6fb31c',
            linkColor: '#0b4c84',
            buttonBg: '#80cb24',
            buttonColor: '#032643',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#eef8de',
            mentionHighlightLink: '#355f0a',
            codeTheme: 'github',
        },
        lagoon: {
            type: 'custom',
